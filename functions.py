...
dirloc = "/home/shahriar0247/all/professional/programming/python/ftp"
dirloc2= dirloc
    ...
    try:
        ...
        for c in filetype:
            if len(c) > 20:
                c = c[:17] + '...'
            filetype1.append(c)
        currentfold2 = currentdir.replace("/home/shahriar0247/all/professional/programming/python/ftp/" + username.replace("/",""), '')
