...
global main_dir
main_dir = '/home/shahriar0247/all/professional/programming/python/ftp/'
temp_dir = '/home/shahriar0247/all/professional/programming/python/temp'
delete_dir = '/home/shahriar0247/all/professional/programming/python/deleted/'
    ...
    if 'username' not in session:
        ...
        if request.method == 'POST':
            if request.files:
                ...
                currentdir = getcurrentdir(dirloc+location, session['username'])
            ...
            path = dirloc + "/"+session['username'] + location 
         
            if os.path.isdir(path):
                
                filename, filetype, currentdir, filename1, filename2, filetype1, currentfold2 = getfolderlist(location, session['username'] +"/")
...
def uploadfile():
    if request.method == 'POST':
        if request.files:
            ...
            print(currentfold2)
            if _file.filename in os.listdir(main_dir + currentfold2):
